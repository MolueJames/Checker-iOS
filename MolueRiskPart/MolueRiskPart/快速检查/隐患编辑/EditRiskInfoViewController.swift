...
final class EditRiskInfoViewController: MLBaseViewController  {
    ...
    @IBOutlet weak var collectionView: UICollectionView! {
        didSet {
            ...
            collectionView.register(forKind:UICollectionElementKindSectionFooter, withNibClass: EditRiskInfoResuableFooterView.self)
...
extension EditRiskInfoViewController: UICollectionViewDelegate {
    func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        let view = collectionView.dequeueReusableSupplementaryView(ofKind: UICollectionElementKindSectionFooter, withClass: EditRiskInfoResuableFooterView.self, for: indexPath)
        return view
    }
