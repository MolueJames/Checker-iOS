//
//  TaskCheckDetailViewController.swift
//  MolueRiskPart
//
...
protocol TaskCheckDetailPresentableListener: class {
...
final class TaskCheckDetailViewController: MLBaseViewController {
    ...
    var listener: TaskCheckDetailPresentableListener?
    ...
    @IBOutlet weak var collectionView: UICollectionView! {
        didSet {
            ...
            collectionView.register(xibWithCellClass: TaskCheckDetailCollectionViewCell.self)
...
extension TaskCheckDetailViewController: TaskCheckDetailPagePresentable {
    func reloadCollectionViewData() {
        self.collectionView.reloadData()
    }
}

extension TaskCheckDetailViewController: TaskCheckDetailViewControllable {
...
extension TaskCheckDetailViewController: UICollectionViewDataSource {
    ...
    func queryCollectionCell(with collectionView: UICollectionView, indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withClass: TaskCheckDetailCollectionViewCell.self, for: indexPath)
        do {
            let listener = try self.listener.unwrap()
