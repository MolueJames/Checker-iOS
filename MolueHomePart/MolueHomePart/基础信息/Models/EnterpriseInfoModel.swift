...
public struct EnterpriseInfoModel {
    ...
    public static func defaultValues() -> [EnterpriseInfoModel]{
        ...
        let model3 = EnterpriseInfoModel(color: UIColor.init(hex: 0xFFC30C), imageName: "enterprise_info_feature", title: "危险特征", description: "未更新", viewPath: HomePath.RiskFeature.rawValue)
        let model4 = EnterpriseInfoModel(color: UIColor.init(hex: 0x999999), imageName: "enterprise_info_manager", title: "安全管理员", description: "1人，更新日期：2018.12.1", viewPath: HomePath.SecurityAdministrator.rawValue)
