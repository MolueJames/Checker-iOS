...
class AppHomeDocument {
    ...
    func addDangerUnitModel(to list: inout [DangerUnitSectionHeaderModel]) {
        let model1 = DangerUnitSectionHeaderModel()
        model1.unitName = "生产车间1"
        model1.unitClass = "企业厂址"
        model1.unitNumber = "BTD000001"
        model1.unitRisks = [DangerUnitRiskModel]()
        let item11 = DangerUnitRiskModel()
        item11.riskName = "超声波清洗"
        item11.riskHead = "赵德胜"
        item11.headPhone = "13962624430"
        item11.riskLevel = "D级"
        item11.riskClass = "作业过程"
        item11.riskMeasure = [RiskMeasureModel("1、操作工上岗前必须接受相关的安全教育并熟悉掌握操作规程"), RiskMeasureModel("2、加强现场检查，发现问题及时整改"), RiskMeasureModel("3、按规定佩戴劳护用品"), RiskMeasureModel("4、现场配备足量消防器材"), RiskMeasureModel("5、建立健全设备维护保养台账")]
        ...
        let item12 = DangerUnitRiskModel()
        item12.riskName = "清洗制绒机"
        item12.riskHead = "赵德胜"
        item12.headPhone = "13962624430"
        item12.riskLevel = "D级"
        item12.riskClass = "设备设施"
        item12.riskMeasure = [RiskMeasureModel("1、开机作业前进行各项检查，有故障及时处理"), RiskMeasureModel("2、按照操作规程认真"), RiskMeasureModel("3、作业人员是穿戴劳动防护用品"), RiskMeasureModel("4、做好常规保养，保证设备安全联动设施完好，并做好记录")]
        ...
        let item13 = DangerUnitRiskModel()
        item13.riskName = "液氧低温储罐"
        item13.riskHead = "赵德胜"
        item13.headPhone = "13962624430"
        item13.riskLevel = "D级"
        item13.riskClass = "设备设施"
        item13.riskMeasure = [RiskMeasureModel("1、使用前对设备行各项检查，及时排查故障"), RiskMeasureModel("2、作业员必须穿戴合格的劳动防护用品"), RiskMeasureModel("3、操作人员安全操作知识培训常态化"), RiskMeasureModel("4、做好常规保养并做好记录")]
        ...
        list.append(model1)
        let model2 = DangerUnitSectionHeaderModel()
        model2.unitName = "生产车间2"
        model2.unitClass = "企业厂址"
        model2.unitNumber = "BTD000002"
        model2.unitRisks = [DangerUnitRiskModel]()
        let item21 = DangerUnitRiskModel()
        item21.riskName = "丝网印刷机"
        item21.riskHead = "赵德胜"
        item21.headPhone = "13962624430"
        item21.riskLevel = "D级"
        item21.riskClass = "作业过程"
        item21.riskMeasure = [RiskMeasureModel("1、使用前对设备行各项检查，及时排查故障"), RiskMeasureModel("2、作业员必须穿戴合格的劳动防护用品"), RiskMeasureModel("3、设备运行时随时观察设备状态"), RiskMeasureModel("4、操作人员安全操作知识培训常态化"), RiskMeasureModel("5、做好常规保养并做好记录")]
