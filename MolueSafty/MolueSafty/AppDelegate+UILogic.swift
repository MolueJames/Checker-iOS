...
extension AppDelegate {
    ...
    private func rootViewController() -> UIViewController {
        ...
        self.addNavigationController(module: .Home, path: HomeFilePath.HomeInfo, viewControllers: &viewControllers, title:"首页", imageName: "molue_tabbar_home")
    ...
    private func addNavigationController(module: MolueNavigatorRouter.RouterHost, path: String, viewControllers: inout [MLNavigationController], title: String, imageName: String){
        let router = MolueNavigatorRouter.init(module, path: path)
